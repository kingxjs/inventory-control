    ...
    <div className="h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_#f6f1e8,_#f3f6fb_35%,_#f7f7f2_70%)] text-slate-900">
      ...
      <Dialog open={accountOpen} onOpenChange={setAccountOpen}>
        <DialogContent className="max-w-sm">
          ...
          <button
            type="button"
            className="w-full rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-600 transition hover:border-slate-300 hover:text-slate-900"
